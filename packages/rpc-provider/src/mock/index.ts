...
import rpcHeader from '@polkadot/types-support/json/Header.004.json' with { type: "json" };
import rpcSignedBlock from '@polkadot/types-support/json/SignedBlock.004.immortal.json' with { type: "json" };
